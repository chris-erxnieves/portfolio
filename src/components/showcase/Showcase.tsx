...
const showcaseItems = [
  {
    ...
    techUsed: ['React', 'Gatsby', 'Chakra', 'AWS', 'Framer Motion'],
    sourceCodeUrl: 'https://github.com/chris-erxnieves/portfolio/',
  ...
  },
  {
    ...
    techUsed: ['React', 'Gatsby', 'AWS', 'styled-components'],
    sourceCodeUrl: 'https://github.com/chris-erxnieves/portfolio/',
    imageNameAndExtension: 'portfolio-v1.webp',
  },
]

export const Showcase: FC<ShowcaseProps> = ({ darkBackground }) => {
